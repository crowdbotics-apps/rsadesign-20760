"""rsadesign_20760 URL Configuration
...
admin.site.site_header = "RSAdesign"
admin.site.site_title = "RSAdesign Admin Portal"
admin.site.index_title = "RSAdesign Admin"

# swagger
api_info = openapi.Info(
    title="RSAdesign API",
    default_version="v1",
    description="API documentation for RSAdesign App",
)
